    ...
    <div className="w-full">
      <div className="w-full fixed px-5 h-14 bg-primary z-50 text-white flex justify-between items-center  font-lato">
        ...
        <div className="md:flex items-center hidden md:visible">
          <Link
            to="/admin/page"
            className="mx-1 p-1 hover:scale-105 hover:text-opacity-100  transition duration-300"
          >
            <div
              className={
                location.pathname === "/admin/page" ? "text-second" : ""
              }
            >
              <HomeOutlined /> Accueil
            </div>
          ...
          <Link
            to="/admin/page/transaction"
            className="mx-1 p-1 hover:scale-105 hover:text-second hover:text-opacity-100  transition duration-300"
          >
            <div
              className={
                location.pathname === "/admin/page/transaction"
          ...
          <button
            onClick={logout}
            className=" border hover:bg-white hover:text-primary transition-all text-white mx-auto font-latobold py-0.5 px-2.5 my-1 rounded-full"
          >
            Deconnexion
          </button>
        </div>
