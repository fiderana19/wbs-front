          ...
          <Controller
            ...
            render={({ field: { value, onChange, onBlur } }) => (
              <Input
                ...
                onChange={onChange}
                onBlur={onBlur}
                className={`w-64 rounded bg-transparent border ${errors.username ? "border-red-500" : ""}`}
              />
            )}
          />
          {errors.username && (
          ...
          <Controller
            ...
            render={({ field: { value, onChange, onBlur } }) => (
              <Input
                ...
                onChange={onChange}
                onBlur={onBlur}
                className={`w-64 rounded bg-transparent border ${errors.password ? "border-red-500 text-red-500" : ""}`}
              />
            )}
          />
          {errors.password && (
