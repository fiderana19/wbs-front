      ...
      <form className="w-2/3 my-7 mx-auto" onSubmit={submit(handleSubmit)}>
        ...
        <Controller
          ...
          render={({ field: { value, onBlur, onChange } }) => (
            <Input
              className={
                errors?.libelle && "text-red-500 border-red-500 rounded"
              }
              value={value}
              onChange={onChange}
              onBlur={onBlur}
        ...
        <Controller
          ...
          render={({ field: { value, onBlur, onChange } }) => (
            <Input
              className={
                errors?.description && "text-red-500 border-red-500 rounded"
              }
              value={value}
              onBlur={onBlur}
              onChange={onChange}
        ...
        <Controller
          ...
          render={({ field: { value, onBlur, onChange } }) => (
            <Input
              className={errors?.pu && "text-red-500 border-red-500 rounded"}
