...
const AddTransanctionPage: FunctionComponent<StepsPropsType> = ({
  handlePrev,
  handleNext,
}) => {
  const {
    ...
    formState,
    handleSubmit: submit,
  } = useForm<CreateTransactionInterface>({
  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        ...
        >
          <Label htmlFor="idproduit" className="mt-2 mb-1">
            Client :{" "}
          </Label>
          <Controller
            control={control}
          ...
          <Label htmlFor="date_transaction" className="mt-2 mb-1">
            Date du transaction :{" "}
          </Label>
          <Controller
            control={control}
          ...
          {errors?.date_transaction && (
            <div className="text-xs text-red-500 text-left">
              {errors?.date_transaction.message?.toString()}
            </div>
          )}
