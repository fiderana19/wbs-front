...
const TransactionSearchPage: FunctionComponent = () => {
  ...
  const [editTransactionCredentials, setEditTransactionCredentials] =
    useState<TransactionForEdit>({ _id: "", date_transaction: "" });
                ...
                <div key={searchTransaction._id}>
                  ...
                  >
                    ...
                    <div className="flex sm:flex-col sm:justify-center sm:pr-0 pr-8 sm:mt-0 mt-2 justify-end z-50">
                      <button
                        className="sm:my-1 p-1 rounded bg-blue-400 hover:bg-blue-500 flex"
                        onClick={() => {
                          setIsModalDetailOpen(false);
                          EditTransaction(searchtransaction);
                        }}
                      >
                        {" "}
                        <EditOutlined />
