    ...
    >
      <div className="text-center">
        ...
        <form className="my-7 w-60 text-left" onSubmit={submit(handleSubmit)}>
          <Label htmlFor="nom_client" className="mb-1">
            Nom :{" "}
          </Label>
          <Controller
            name="nom_client"
            ...
            render={({ field: { onChange, value, onBlur } }) => (
              <Input
                className={`my-1 ${errors.nom_client && "my-1 border-red-500 text-red-500 rounded"}`}
                value={value}
                onChange={onChange}
                onBlur={onBlur}
              />
          ...
          />
          {errors?.nom_client && (
            <div className="text-left text-red-500 text-xs">
              {errors.nom_client.message}
            </div>
          )}
          <Label htmlFor="adresse_client" className="mt-4 mb-1">
            Adresse :{" "}
          </Label>
          <Controller
            control={control}
            ...
            render={({ field: { value, onChange, onBlur } }) => (
              <Input
                className={`my-1 ${errors.adresse_client && "my-1 border-red-500 text-red-500 rounded"}`}
                value={value}
                onChange={onChange}
                onBlur={onBlur}
              />
          ...
          <Label htmlFor="mail_client" className="mt-4 mb-1">
            Mail :{" "}
          </Label>
          <Controller
            control={control}
            ...
            render={({ field: { value, onBlur, onChange } }) => (
              <Input
                className={`my-1 ${errors.mail_client && "my-1 border-red-500 text-red-500 rounded"}`}
                value={value}
                onChange={onChange}
          ...
          <Label htmlFor="telephone_client" className="mt-4 mb-1">
            Numero de telephone :{" "}
          </Label>
          <Controller
            control={control}
            ...
            render={({ field: { value, onChange, onBlur } }) => (
              <Input
                className={`my-1 ${errors.telephone_client && "my-1 border-red-500 text-red-500 rounded"}`}
                value={value}
                onChange={onChange}
                onBlur={onBlur}
